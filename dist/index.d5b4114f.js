...
})({"lkwfB":[function(require,module,exports) {
"use strict";
...
class MealFeedView extends View {
    ...
    render() {
        ...
        for(let i = (curPage - 1) * 10; i < curPage * 10; i++){
            const { strMealThumb , strCategory , idMeal , strMeal , strYoutube , strSource ,  } = this.feeds.meals[i];
            this.addHtml(`
    ...
    `);
        ...
        this.setTemplateData("next_page", String(curPage >= Math.floor(this.feeds.meals.length / 10) ? curPage : curPage + 1));
        this.updateView();
    }
}
class MealDetailView extends View {
    ...
    render() {
        ...
        const mealFeed = api.getData();
        const { strMeal , strCategory , strArea , strYoutube , strSource , strInstructions , strMealThumb ,  } = mealFeed.meals[0];
        this.setTemplateData("meal_ingredient", this.makeingredients(mealFeed.meals[0]));
...
},{}]},["lkwfB","2iQTb"], "2iQTb", "parcelRequire94c2")
