...
const mealFeedView = new (0, _page.MealFeedView)("root", store);
const mealDetailView = new (0, _page.MealDetailView)("root", store);
router.setDefaultPage(mealFeedView);
router.addRouterPath("/page/", mealFeedView);
router.addRouterPath("/show/", mealDetailView);
router.route(); // typescript로 window에 store라는 속성 추가하는 방법
 // const store: Store = {
 //   currentPage: 1,
 // };
 // declare global {
...
},{"./core/router":"f4hn2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./page":"4GSC5","./store":"1eAgN"}],"f4hn2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MealDetailView", ()=>(0, _mealDetailViewDefault.default));
parcelHelpers.export(exports, "MealFeedView", ()=>(0, _mealFeedViewDefault.default));
var _mealDetailView = require("./meal-detail-view");
var _mealDetailViewDefault = parcelHelpers.interopDefault(_mealDetailView);
var _mealFeedView = require("./meal-feed-view");
var _mealFeedViewDefault = parcelHelpers.interopDefault(_mealFeedView);

},{"./meal-detail-view":"9YctX","./meal-feed-view":"8PFlC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9YctX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
let template = `
  ...
  `;
class MealDetailView extends (0, _viewDefault.default) {
    ...
    async render() {
        ...
        const api = new (0, _api.MealDetailApi)((0, _config.CONTENT_URL).replace("@id", id));
        const data = await api.getData();
        const { strMeal , strCategory , strArea , strYoutube , strSource , strInstructions , strMealThumb ,  } = data.meals[0];
...
parcelHelpers.export(exports, "MealFeedApi", ()=>MealFeedApi);
parcelHelpers.export(exports, "MealDetailApi", ()=>MealDetailApi);
class Api {
    constructor(url){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8PFlC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _config = require("../config");
var _api = require("../core/api");
...
`;
class MealFeedView extends (0, _viewDefault.default) {
    constructor(containerId, store){
        super(containerId, template);
        this.api = new (0, _api.MealFeedApi)((0, _config.SEARCH_URL));
        this.store = store;
    }
    async render() {
        this.store.currentPage = +location.hash.substring(7) || 1;
        if (!this.store.hasData) this.store.setData(await this.api.getData());
        const curPage = this.store.currentPage;
        for(let i = (curPage - 1) * 10; i < curPage * 10; i++){
            const { idMeal , strMeal , strYoutube , strSource , strMealThumb , strCategory ,  } = this.store.getData(i);
            this.addHtml(`
...
class Store {
    ...
    getNextPage() {
        if (this.hasData) return this._currentPage >= Math.floor(this._data.length / 10) ? this._currentPage : this._currentPage + 1;
        else return 0;
    }
}
exports.default = Store;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4ibyE","kuM8f"], "kuM8f", "parcelRequire94c2")
